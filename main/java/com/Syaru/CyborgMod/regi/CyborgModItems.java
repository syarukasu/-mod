...
public class CyborgModItems {
    ...
    // Blueprint アイテムの登録
    public static final RegistryObject<Item> BASIC_BLUEPRINT =
            ITEMS.register("basic_blueprint", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> DEEPENED_BLUEPRINT =
            ITEMS.register("deepened_blueprint", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> SUBTLE_BLUEPRINT =
            ITEMS.register("subtle_blueprint", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> ZENITH_BLUEPRINT =
            ITEMS.register("zenith_blueprint", () -> new Item(new Item.Properties()));
