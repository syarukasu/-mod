...
public class ConsoleGui extends Screen {
    ...
    // 背景画像のリソース
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("cyborgmod", "textures/gui/console_gui.png");
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(centerX + 50, centerY + 70, 80, 20, Component.literal("Activate"), button -> {
            // ボタンをクリックしたときのアクション
            if (player != null) {
                Minecraft.getInstance().gui.getChat().addMessage(Component.literal("Console activated!"));
            }
        }));
    }
